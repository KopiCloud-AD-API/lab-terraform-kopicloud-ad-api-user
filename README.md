# Lab Files for KopiCloud AD API Terraform Provider AD Users
...
This repo contains a files to test and evaluate KopiCloud AD API Terraform Provider AD Users
...
3. Execute the **ad-test-users.cmd** file
